...
export default function PersonaLanding() {
  ...
  const characters = [
    {
      ...
      description:
        "Retired from corporate and full time YouTuber, x founder of LCO (acquired), x CTO, Sr. Director at PW, 2 YT channels (950k & 470k)",
      image:
        "https://firebasestorage.googleapis.com/v0/b/project-x-e3c38.appspot.com/o/hitesh.png?alt=media&token=fd7daf18-3ce0-445a-bc1f-5f945e3ae86b",
      color: "from-emerald-400 to-emerald-600",
      bgColor: "bg-emerald-500",
      specialty: "Retired corporate and full time YouTuber",
      apiEndpoint: "http://localhost:5000/api/hitesh/chat",
    },
    {
      id: 2,
      name: "Piyush Garg",
      description:
        "Building Teachyst - Platform for educators and creators | YouTuber | Educator | Founder of pro.piyushgarg.dev",
      image:
        "https://firebasestorage.googleapis.com/v0/b/project-x-e3c38.appspot.com/o/piyush.webp?alt=media&token=fe5c226e-4360-423e-a237-8e7428dc7db9",
      color: "from-blue-400 to-blue-600",
      bgColor: "bg-blue-500",
      specialty: "Full-Stack Development and  full time YouTuber",
      apiEndpoint: "http://localhost:5000/api/piyush/chat",
    },
  ];
  ...
  const sendMessage = async () => {
    ...
    try {
      // Call the appropriate API based on selected character
      const response = await axios.post(selectedCharacter.apiEndpoint, {
        message: inputMessage,
      });
